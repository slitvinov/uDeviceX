...
static std::vector<Particle> ic_pos_solvent() { /* generate particle position */
  srand48(0);
...
static std::vector<Particle> ic_pos_nosolvent() { /* generate particle position */
  std::vector<Particle> pp;
  Particle p = Particle();
  p.r[X] = p.r[Y] = p.r[Z] = 0;
  p.v[X] = p.v[Y] = p.v[Z] = 0;
...
static std::vector<Particle> ic_pos() { /* generate particle position */
  return nosolvent ? ic_pos_nosolvent() : ic_pos_solvent();
}
