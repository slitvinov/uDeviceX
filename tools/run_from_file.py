...
def gen_templates():
    ...
    pt['aij_out_rbc']          = '#define %s (( %g ) / rc)\n'
    pt['aij_in_rbc']           = '#define %s (( %g ) / rc)\n'
    pt['gammadpd_out']         = '#define %s ( %g )\n'
    pt['gammadpd_in']          = '#define %s ( %g )\n'
    pt['gammadpd_rbc']         = '#define %s ( %g )\n'
    pt['gammadpd_wall']        = '#define %s ( %g )\n'
    pt['gammadpd_out_rbc']     = '#define %s ( %g )\n'
    pt['gammadpd_in_rbc']      = '#define %s ( %g )\n'
...
def set_defaults():
    ...
    pv['gammadpd_rbc']         = 15
    pv['gammadpd_wall']        = 15
    pv['gammadpd_out_rbc']     = 0
    pv['gammadpd_in_rbc']      = 0
    pv['ljsigma']              = 0.3
    pv['ljepsilon']            = 1.0
    pv['RBCrc']                = 1
    pv['RBCx0']                = 0.45
