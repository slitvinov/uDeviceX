...
HS = "<awk 'NR >= 45 && $2 == 15 && $3 == 5 && $4 == 15' data/post.sk.txt | sort -g -k 5" # sHear Simulation
R = "data/diam.sk.pdf"
...
plot HS u 5:18                            w lp pt 6 lc "light-red"  t "simulation", \
     ...
     "" u ($1/tsc):($2/R0):($3/R0)        w lp pt 7 lc "dark-red"   t "", \
     "" u ($1/tsc):($4/R0)                w lp pt 7 lc "dark-red"   t "", \
     "" u ($1/tsc):($4/R0):($5/R0)        w lp pt 7 lc "dark-red"   t "", \
